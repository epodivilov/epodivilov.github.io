...
params => {
  ...
  /** @type {Params} */
  {
    ...
    (0, _range.range)(settings.length).forEach(i => {
      ...
      const el = new _geometries.Circle(x, y, radius);
...
},{"tweakpane":"yZzA","canvas-sketch":"bkbf","../../../utils/range":"bwFq","../../../utils/geometries":"NlR3"}]},{},["Focm"], null)
//# sourceMappingURL=src.a42b9c53.js.map